		...
		<div class="contents d-flex">
			...
			<nav class="col-2">
				...
				<ul class="nav flex-column mt-4">
					...
					<li class="nav-item"><a href="/lesson05/aad_weather_view"
						class="nav-link menu-font">날씨입력</a></li>
					<li class="nav-item"><a href="#" class="nav-link menu-font">테마관측</a></li>
						...
						<c:forEach items="${weatherHistoryList}" var="weather">
							<tr>
								...
								<td><c:choose>
										...
										<c:when test="${weather.weather eq '구림조금'}">
